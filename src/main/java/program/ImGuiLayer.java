...
public class ImGuiLayer {
    ...
    public void initImGui() {
        ...
        glfwSetKeyCallback(glfwWindow, (w, key, scancode, action, mods) -> {
            ...
            //if(!io.getWantCaptureKeyboard()){
                Window.get().keyCallback(w, key, scancode, action, mods);
            //}
        });
        ...
        glfwSetMouseButtonCallback(glfwWindow, (w, button, action, mods) -> {
            ...
            if(!io.getWantCaptureMouse()) {
                Window.get().mouseButtonCallback(w, button, action, mods);
            }
        });
        ...
        glfwSetScrollCallback(this.glfwWindow, (w, xOffset, yOffset) -> {
            ...
            if(!io.getWantCaptureMouse()){
                Window.get().mouseScrollCallback(w, xOffset, yOffset);
            }
        });
        ...
        fontAtlas.addFontFromFileTTF("assets/fonts/OtomanopeeOne-Regular.ttf", 28, fontConfig);
    ...
    private void startFrame(final float deltaTime) {
        ...
        float[] winWidth = {Window.getWidth()}, winHeight = {Window.getHeight()};
        double[] mousePosX = {0f}, mousePosY = {0f};
